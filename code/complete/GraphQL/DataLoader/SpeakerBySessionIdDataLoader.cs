...
{
    private static readonly string SpeakerCacheKey = GetCacheKeyType<SpeakerByIdDataLoader>();
        ...
        CancellationToken cancellationToken)
    {
        ...
        TryAddToCache(SpeakerCacheKey, list, item => item.SpeakerId, item => item.Speaker!);
